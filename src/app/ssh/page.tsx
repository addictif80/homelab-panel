...
export default function SshPage() {
  ...
  const [credKind, setCredKind] = useState<"ssh_key" | "ssh_password">("ssh_key");
          ...
          <div className="space-y-2 border-t border-neutral-800 pt-4">
            ...
            {showCredForm && (
              <form onSubmit={addCredential} className="space-y-2 rounded border border-neutral-800 p-2">
                <select
                  value={credKind}
                  onChange={(e) => setCredKind(e.target.value as "ssh_key" | "ssh_password")}
                ...
                >
                  ...
                  <option value="ssh_password">Mot de passe</option>
                </select>
                <input
